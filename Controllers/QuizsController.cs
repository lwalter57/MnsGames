...
namespace MnsGames.Controllers
{
    ...
    public class QuizsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,QuizName,Duration,AppUserId,ThemeId")] Quiz quiz)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,QuizName,Duration,AppUserId,ThemeId")] Quiz quiz)
        {
            if (id != quiz.Id)
            {
                return NotFound();
